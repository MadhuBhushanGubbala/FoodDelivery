                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="all-tickets.jsp">All Tickets</a>
                                </li>
								<?php
                                    ...
                                    echo '<li class='.(isset($_GET['status'])?($status == $_GET['status'] ? 'active' : ''): '').'><a href="all-tickets.jsp?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
        ...
        <div class="container">
          ...
          <div class="divider"></div>
								...
								<?php
									...
									while($row = mysqli_fetch_array($sql)){								                                
									echo'<a href="view-ticket-admin.jsp?id='.$row['id'].'"class="collection-item">
                                        <div class="row">
                                            <div class="col s6">
