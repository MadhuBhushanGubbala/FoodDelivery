                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> Tickets</a>
                            <div class="collapsible-body">
								...
								<?php
                                    ...
                                    echo '<li class='.(isset($_GET['status'])?($status == $_GET['status'] ? 'active' : ''): '').'><a href="tickets.jsp?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
...
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-ticket.jsp" novalidate="novalidate" class="col s12">
                      <div class="row">
        ...
        <div class="container">
          ...
          <div class="divider"></div>
								...
								<?php
									...
									while($row = mysqli_fetch_array($sql)){								                                
									echo'<a href="view-ticket.jsp?id='.$row['id'].'"class="collection-item">
                                        <div class="row">
                                            <div class="col s6">
...
<?php
	...
	else
	{
		...
		{
			header("location:all-tickets.jsp");		
		}
		else{
